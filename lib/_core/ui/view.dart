...
// ///       CounterState(CounterController controllers) : super(controllers);
// ///
// ///       @override
...
// abstract class ResponsiveViewState<Page extends View, Con>
//     extends ViewState<Page, Con> {
//   ResponsiveViewState(Con controllers) : super(controllers);
//
...
// ///                             // widget provides the controllers with a way to access them via getContext(), getState(), getStateKey()
// ///             body: Column(
// ///               children: <Widget>[
// ///                 Center(
// ///                   // show the number of times the button has been clicked
// ///                   child: Text(controllers.counter.toString()),
// ///                 ),
// ///                 // you can refresh manually inside the controllers
// ///                 // using refreshUI()
// ///                 MaterialButton(onPressed: controllers.increment),
// ///               ],
// ///             ),
// ///           ),
// ///         );
...
// ///
// /// ```
// abstract class ViewState<Page extends View, Con> extends State<Page> {
